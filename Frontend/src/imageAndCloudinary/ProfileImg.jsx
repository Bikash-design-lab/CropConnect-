...
const ProfileImg = memo(({ profile, onImageUpdate }) => {
    ...
    return (
        <div className="flex flex-col items-center">
            <div className="w-[12rem] h-[12rem] rounded-full overflow-hidden border  border-gray-300">
                <img
                    src={preview}
                    alt="profile"
            ...
            <label className=" mt-2 cursor-pointer text-sm font-semibold text-white px-4 py-1 bg-blue-600 border-black border rounded-lg shadow hover:bg-blue-700 hover:shadow-md transition-all duration-200 flex items-center justify-center">
