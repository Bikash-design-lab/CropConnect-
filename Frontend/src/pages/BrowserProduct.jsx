...
//     setFilteredProducts(result)
//     setVisibleCount(6) // Reset visible count on new filter/sort
//   }, [searchTerm, sortOption, products])
...
//           <div
//             key={product._id}
//             className="p-6 rounded shadow-xl bg-white/80 backdrop-blur-sm hover:shadow-2xl transition transform hover:scale-[1.02] flex flex-col"
//           >
//             <div className="flex gap-2 mb-4 overflow-x-auto">
//               {product.images?.map((img, idx) => (
//                 <img
...
//               ))}
//             </div>
//                <p className="text-blue-500 text-bold">{product.status.charAt(0).toUpperCase() + product.status.slice(1)}</p>
...
//             <button
//               onClick={() => handleAddToCart(product._id)}
//               className="mt-4 w-full py-2 px-4 text-white bg-gradient-to-r from-green-600 to-blue-600 rounded hover:scale-105 transition shadow"
//               disabled={product.status.toLowerCase() !== "available"}
//             >
//               <ShoppingCart className="h-4 w-4 inline mr-2" />
//               Add to Cart
