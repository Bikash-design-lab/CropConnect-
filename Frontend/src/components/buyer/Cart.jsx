...
// const removeProductFromCartApi = `${BASE_API}/cancelOrder/:productId`
...
//   // remove product from added to cart
...
//             <h2 className="text-xl font-semibold text-gray-900 mb-2">Your cart is empty</h2>
//             <p className="text-gray-600 mb-6">Add some fresh produce to get started!</p>
//             <button className="bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded" onClick={()=>navigate("/products/browse")}>
//               Continue Shopping
//             </button>
//           </div>
//         ) : (
