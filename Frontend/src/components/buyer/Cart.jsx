...
import {
  Minus, Plus, Trash2, ShoppingCart, Truck, Shield, MapPin,
} from "lucide-react"
...
const Cart = () => {
  ...
  const calculateSubtotal = () => {
    return products.reduce((total, product) => total + product.pricePerUnit * (product.quantityAvailable || 1), 0)
  }
        ...
        {products.length === 0 ? (
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-col sm:flex-row justify-between items-center">
                        <div className="text-right">
                          <p className="text-sm text-gray-500">₹{product.pricePerUnit} / {product.unit}</p>
                          <p className="text-sm text-gray-500">Quantity :{product.quantityAvailable} {product.unit}</p>
                          <p className="text-lg font-semibold text-gray-900">
                            Amount: ₹{(product.pricePerUnit * (product.quantityAvailable || 1)).toFixed(2)}
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            <div className="xl:col-span-1 space-y-4 bg-white shadow rounded p-6 sticky top-4">
              ...
              <button className="w-full border py-2 rounded" onClick={goToDashboard}>Continue Shopping</button>
...
// const API = "http://localhost:3000/orderProduct/getProductFromCart"
// const DELIVERY_CHARGE = 49
...
//             <h2 className="text-xl font-semibold text-gray-900 mb-2">Your cart is empty</h2>
//             <p className="text-gray-600 mb-6">Add some fresh produce to get started!</p>
//             <button className="bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded" onClick={goToDashboard} >
//               Continue Shopping
//             </button>
//           </div>
//         ) : (
...
//                 {processingPayment ? "Processing..." : `Pay ₹${calculateTotal().toFixed(2)}`}
//               </button>
//               <button className="w-full border py-2 rounded">Continue Shopping</button>
//               <div className="text-xs text-gray-500 pt-4 space-y-1">
//                 <div className="flex items-center gap-1">
//                   <Shield className="h-3 w-3" />
//                   Secure checkout with SSL encryption
